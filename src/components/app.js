...
export default class App extends Component {
  ...
  checkLoginStatus() { //axios always returns a promise
    ...
    .then(response => {
      ...
      const loggedIn = response.data.logged_in; //response coming back from api
      const loggedInStatus = this.state.loggedInStatus; //handling state
  ...
  authorizedPages() {
    ...
    ]; //Route guard code, only links in here will be accessible for logged in users
  }
        ...
        <Router>
          <div>
            ...
            <Switch>
              ...
              render={props => (
                <Auth 
                {...props} //have access to all the props it would anyway
