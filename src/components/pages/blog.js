...
class Blog extends Component {
    ...
    getBlogItems() {
        ...
        axios.get(`https://kaitlynfriden.devcamp.space/portfolio/portfolio_blogs?page=${this.state.currentPage}`, { withCredentials: true })
        .then(response => {
    ...
    render() {
        ...
        return (
            <div className="blog-container">
                <BlogModal modalIsOpen={this.state.blogModalIsOpen} handleModalClose={this.handleModalClose} handleSuccesfulNewBlogSubmission={this.handleSuccesfulNewBlogSubmission}/>
