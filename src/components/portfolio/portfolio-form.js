...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: "",
            editMode: false,
            apiUrl: "https://kaitlynfriden.devcamp.space/portfolio/portfolio_items",
            apiAction: "post"
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://kaitlynfriden.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: "patch",
    ...
    buildForm() {
        ...
        formData.append("portfolio_item[name]", this.state.name); //using bracket synax to respresent an object and calling the values
                ...
                <form onSubmit={this.handleSubmit} className="portfolio-form-wrapper">
                    ...
                    <div className="two-column">
                        ...
                        <select name="category" value={this.state.category} onChange={this.handleChange} className="select-element">
                            ...
                            <option value="ReactApps">ReactApps</option>
